...
/**
 * Created by xyj on 2017/1/12.
 */
public class BatchThreadPoolFactory {

    private static Log log = LogFactory.getLog(BatchThreadPoolFactory.class);
    ...
    public static void putMessage(SendUserInfo suInfo,int pushServer)
    {
        try{
            ...
            log.error("BatchThreadPoolFactory：" +suInfo.toString(),e);
        }
    }
