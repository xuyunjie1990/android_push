package plugins.xinge;

import plugins.xinge.json.JSONObject;
import plugins.xinge.tencent.*;
...
// 易用接口
		System.out.println(XingeApp.pushTokenAndroid(2100135687, "b3cad923cbfe1b6350465013e5628d54", "test7", "测试7", "7508c92bf14b1e2f47c29ffb119a8ae4cba8867e"));
//		System.out.println(XingeApp.pushAccountAndroid(000, "secretKey", "test", "测试", "account"));
		//System.out.println(XingeApp.pushAllAndroid(2100135687, "b3cad923cbfe1b6350465013e5628d54", "test3", "测试3"));
...
//      System.out.println(ret);
	...
	protected JSONObject demoPushDeviceListMultiple() {
		...
		if (ret.getInt("ret_code") != 0)
            ...
            // ...
            result.append("all", xinge.pushDeviceListMultiple(ret.getJSONObject("result").getString("push_id"), deviceList1));

            List<String> deviceList2 = new ArrayList<String>();
            deviceList2.add("joelliu3");
            deviceList2.add("joelliu4");
            // ...
            result.append("all", xinge.pushDeviceListMultiple(ret.getJSONObject("result").getString("push_id"), deviceList2));
            return (result);
        }
	}
